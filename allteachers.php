							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="addstudents.php" class="btn btn-primary">+ Add new</a>
									</div>
                                            ...
                                            ?>
												...
												<tbody>
													<tr>
														...
														<td>
															<a href="updatestudents.php" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a><span></span></td>
															<td><a href="deleteteachers.php?student_id=<?php echo $row["teachers_id"]; ?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
														</td>												
													</tr>
